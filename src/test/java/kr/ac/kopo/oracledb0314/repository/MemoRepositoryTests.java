...
public class MemoRepositoryTests {
    ...
    //MemoRepository의 findByIDd(Memo Entity 객체의 Id로 설정된 필드값)를 호출해서 select한다.
    //findById()호출하면 바로 select문을 실행한다.
    ...
    // MemoRepository의 delete(MemoEntity의 mno 값)를 호출해서 delete한다.
    @Test
    ...
    public void testQueryMethod3(){
        memoRepository.deleteMemoByMno(5L);
        testPagetDefault();
    }
